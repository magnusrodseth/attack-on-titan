...
- Forest of Giant Trees foliage: cut-out leaf cards composited from [Leaf Set 019](https://ambientcg.com/view?id=LeafSet019) (conifer sprays) and [Leaf Set 024](https://ambientcg.com/view?id=LeafSet024) (broadleaf) from [ambientCG](https://ambientcg.com) (CC0)
- Forest of Giant Trees: giant-tree bark ([Bark Willow 02](https://polyhaven.com/a/bark_willow_02) — deep vertical ridges, the cliff-face read the references show), mid-story bark ([Bark Brown 02](https://polyhaven.com/a/bark_brown_02)), forest floor ([Forest Ground 06](https://polyhaven.com/a/forest_ground_06)) and clearing grass ([Leafy Grass](https://polyhaven.com/a/leafy_grass)) from [Poly Haven](https://polyhaven.com/textures) (all CC0)
- Civilian townsfolk skin (faces, hands) cropped from ["Human skin close-up"](https://commons.wikimedia.org/wiki/File:Human_skin_close-up.jpg) by tongcreator via Wikimedia Commons (CC0) — lighting flattened and cross-dissolved into a seamless tile; deliberately not the brown-leather `skin.jpg` the titans wear
- Civilian townsfolk clothing: coarse wool ([Fabric031](https://ambientcg.com/view?id=Fabric031)), slubby canvas/homespun ([Fabric045](https://ambientcg.com/view?id=Fabric045)) and fine woven cotton ([Fabric019](https://ambientcg.com/view?id=Fabric019)) from [ambientCG](https://ambientcg.com) (all CC0) — near-neutral weaves chosen so per-instance `instanceColor` tints read cleanly across the crowd
- Civilian leather (aprons, belts, boots) from [Leather014](https://ambientcg.com/view?id=Leather014) on [ambientCG](https://ambientcg.com) (CC0) — warm scuffed red-brown, distinct from the tan titan-flesh leather
